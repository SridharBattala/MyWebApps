...
class Problems {
   ...
   */
     ...
     public static int rgb(String string) {
       //loop string, get r, g, b count, output is min of r,g,b count
       return -1;
     }
    ...
    */
    ...
    public static ArrayList missingNumber(int n, int[] arr) {
      // initialize array 1 to N, place 1 in output array if matching element to index
    	//return all the elements where element value is 0 in putput array
