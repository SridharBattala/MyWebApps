...
public class PerfectSumDynamic {
	...
	static void printSubsetsRec(int arr[], int i, int sum, ArrayList<Integer> p) {
		...
		// is true.
		System.out.println("arr="+Arrays.toString(arr)+",i="+i+",sum="+sum+", p="+p.toString());
	...
	static void printTable(boolean[][] dp, int rowsLength, int columnLength) {
